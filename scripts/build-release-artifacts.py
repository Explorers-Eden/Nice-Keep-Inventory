...
mod_id = "mr_nice_keep_inventory"
mod_name = "Nice Keep Inventory"
slug = "nice-keep-inventory"
description = "Nice Keep Inventory packaged as a universal data/resource mod."
icon = "nice-keep-inventory_pack.png"
namespace = "keepinv"
