...
execute if data storage eden:temp keepinv.grave{is_owner:true} run advancement grant @s only eden:adventure/grave_robber
execute if data storage eden:temp keepinv.grave{is_owner:true} run advancement grant @s only eden:adventure/six_feet_under_briefly recovered_own_grave
